...
var createProductService = function createProductService(inputData) {
...
var getAllPageProductService = function getAllPageProductService(page, limit, categoryId) {
  return new Promise(/*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee2(resolve, reject) {
      var offset, _yield$db$Product$fin, count, rows, totalPage;
...
var getTopProduct = function getTopProduct(limitInput, categoryId) {
  return new Promise(/*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee7$(_context7) {
        while (1) switch (_context7.prev = _context7.next) {
          case 0:
            ...
            _calculateStartAndEnd = calculateStartAndEnd(time), start = _calculateStartAndEnd.start, end = _calculateStartAndEnd.end; // Fetch revenue from the database
            _context7.next = 5;
            return _index["default"].Order.findAll({
              where: {
                createdAt: _defineProperty(_defineProperty({}, _sequelize.Op.gte, start), _sequelize.Op.lt, end)
              },
              attributes: ["paymentId", [_index["default"].sequelize.fn("SUM", _index["default"].sequelize.col("totalPrice")), "totalRevenue"]],
              include: [{
                model: _index["default"].AllCode,
                as: "paymentData",
                attributes: ["value"]
          ...
          case 9:
            ...
            console.error("Error fetching revenue:", _context7.t0); // Log the error for debugging
            reject({
              errCode: 1,
      ...
      return _regeneratorRuntime().wrap(function _callee8$(_context8) {
        while (1) switch (_context8.prev = _context8.next) {
          case 0:
            ...
            _context8.next = 7;
            return _index["default"].Order.count({
              where: {
                createdAt: _defineProperty(_defineProperty({}, _sequelize.Op.gte, startOfDay), _sequelize.Op.lt, endOfDay)
              }
            });
          case 7:
            amountOrder = _context8.sent;
            resolve({
              errCode: 0,
              errMessage: "Success",
              data: amountOrder
          ...
          case 11:
            ...
            console.error("Error fetching amount order:", _context8.t0); // Log the error for debugging
            reject({
              errCode: 1,
    ...
    var _ref9 = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee9(resolve, reject) {
      ...
      return _regeneratorRuntime().wrap(function _callee9$(_context9) {
        while (1) switch (_context9.prev = _context9.next) {
          ...
          case 3:
            amountOrderNotConfirm = _context9.sent;
            resolve({
              errCode: 0,
              errMessage: "Success",
          ...
          case 7:
            ...
            console.error("Error fetching amount order not confirm:", _context9.t0); // Log the error for debugging
            reject({
              errCode: 1,
      ...
      return _regeneratorRuntime().wrap(function _callee10$(_context10) {
        while (1) switch (_context10.prev = _context10.next) {
          case 0:
            ...
            _context10.next = 7;
            return _index["default"].Order.sum("totalPrice", {
              where: {
                createdAt: _defineProperty(_defineProperty({}, _sequelize.Op.gte, startOfDay), _sequelize.Op.lt, endOfDay)
              }
            });
          case 7:
            revenueToday = _context10.sent;
            resolve({
              errCode: 0,
              errMessage: "Success",
          ...
          case 11:
            ...
            console.error("Error fetching revenue today:", _context10.t0); // Log the error for debugging
            reject({
              errCode: 1,
...
var _default = exports["default"] = {
  ...
  getAllPageProductService: getAllPageProductService,
